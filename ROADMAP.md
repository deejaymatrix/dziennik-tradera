...
| Cel | Zakres                                                                               | Status       |
| --- | ------------------------------------------------------------------------------------ | ------------ |
| 1.1 | Repozytorium, standardy, uruchomiony podgląd (Vite + Tauri dev), error boundary, ADR | 🚧 w trakcie |
| 1.2 | Baza danych SQLite, migracje wersjonowane, repozytoria, WAL, kopia przed migracją    | ⬜           |
